...
CREATE TABLE IF NOT EXISTS settings (
  ...
  value       INTEGER
    ...
    {
      createWord(db, 1, "file", "ファイル");
      createWord(db, 2, "file", "File");
      createWord(db, 1, "filenew", "新しいファイル");
      ...
      createWord(db, 1, "quit", "終了");
      createWord(db, 2, "quit", "Quit");
      createWord(db, 1, "cancel", "キャンセル");
      createWord(db, 2, "cancel", "Cancel");
      createWord(db, 1, "ok", "OK");
      ...
      createWord(db, 1, "editorconsoleclear", "消す");
      createWord(db, 2, "editorconsoleclear", "Clear");
      createWord(db, 1, "edit", "編集");
      createWord(db, 2, "edit", "Edit");
      createWord(db, 1, "editundo", "元に戻す");
      createWord(db, 2, "editundo", "Undo");
      createWord(db, 1, "editredo", "やり直し");
      createWord(db, 2, "editredo", "Redo");
      createWord(db, 1, "editcut", "切り取り");
      createWord(db, 2, "editcut", "Cut");
      createWord(db, 1, "editcopy", "コピー");
      createWord(db, 2, "editcopy", "Copy");
      createWord(db, 1, "editpaste", "貼り付け");
      createWord(db, 2, "editpaste", "Paste");
      createWord(db, 1, "editduplicate", "行を複製");
      createWord(db, 2, "editduplicate", "Duplicate");
      createWord(db, 1, "settings", "設定");
      createWord(db, 2, "settings", "Settings");
      createWord(db, 1, "build", "ビルド");
      createWord(db, 2, "build", "Build");
      createWord(db, 1, "buildcompile", "コンパイル");
      createWord(db, 2, "buildcompile", "Compile");
      createWord(db, 1, "help", "ヘルプ");
      createWord(db, 2, "help", "Help");
      createWord(db, 1, "helpmanual", "マニュアル");
      ...
      createWord(db, 1, "helpabout", "Shader Playgroundについて");
